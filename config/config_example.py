...
FEATURES = {
    'tjh': {
        'Basic': ['PatientID', 'RecordTime', 'AdmissionTime', 'DischargeTime'],
...
DATASETS_PATH = {
    'tjh': 'datasets/tjh/subdatasets/10samples.csv',
    'mimic-iv': 'datasets/mimic-iv/subdatasets/mimic-iv_sample.csv',
}
params = [
    {
